...
colcon build --symlink-install --packages-select robotic_arm_motion
source install/setup.bash
```

If you want to use `start_panda:=true` or `panda_bringup.launch.py`, build bringup too:
...
```bash
ros2 launch robotic_arm_motion panda_bringup.launch.py
```

Run demos:

```bash
ros2 launch robotic_arm_motion demo_01_point_to_point.launch.py
ros2 launch robotic_arm_motion demo_02_straight_line.launch.py
ros2 launch robotic_arm_motion demo_03_circle_bump.launch.py
ros2 launch robotic_arm_motion demo_04_rectangle_shape.launch.py
ros2 launch robotic_arm_motion demo_05_workspace_reject.launch.py
ros2 launch robotic_arm_motion demo_06_moveit_pose_goal.launch.py
ros2 launch robotic_arm_motion demo_07_moveit_arm_hand_pose_goal.launch.py
```

If Panda is already running:

```bash
ros2 launch robotic_arm_motion demo_01_point_to_point.launch.py start_panda:=false
```
...
```bash
ros2 launch robotic_arm_motion demo_06_moveit_pose_goal.launch.py start_panda:=false start_delay_sec:=0.5
```
