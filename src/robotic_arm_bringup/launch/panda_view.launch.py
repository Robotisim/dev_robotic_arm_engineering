...
def generate_declared_arguments() -> List[DeclareLaunchArgument]:
    return [
        DeclareLaunchArgument(
            'description_package',
            default_value='robotic_arm_description',
            description='Custom package with robot description.',
        ),
        DeclareLaunchArgument(
            'description_filepath',
            default_value=path.join('urdf', 'panda', 'panda.xacro.urdf'),
        ...
        DeclareLaunchArgument(
            ...
            default_value=path.join(
                get_package_share_directory('robotic_arm_moveit_config'), 'rviz', 'view.rviz'
            ),
